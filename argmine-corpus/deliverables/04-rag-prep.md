...
- 102 chunks over 140 records
- 0 chunks from extracted full text, 8 from guidelines/READMEs, 94 from abstracts where no full text was available
- token histogram: 0-199: 56, 200-399: 45, 400-599: 1
...
|---|---|---|
| `tier` | unrecorded: 110, 2: 74, 3: 40, 4: 14, 1: 12 | T1/T2 to ground claims about the field, T3 for schema decisions, T4 for current practice |
| `area` | mining: 127, resources: 70, quality: 56, llm: 55, formal: 53, dialogue: 40 | keep an answer inside one area's literature; `dialogue` is the one upstream of a transcript database |
| `doc_type` | conference: 119, workshop: 88, journal: 36, chapter: 3, book: 2, preprint: 1, unrecorded: 1 | separate a dataset or guideline from a method paper - ask a schema question of `dataset`/`guideline`/`tool` only |
