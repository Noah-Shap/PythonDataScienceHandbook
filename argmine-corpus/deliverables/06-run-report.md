...
| `fallacy detection` | 6.7 | bibcorpus | 6 |
...
| `large language models argument mining` | 6.7 | bibcorpus | 0 |
...
- `doi:10.18653/v1/2024.argmining-1.7` - MAMKit: A Comprehensive Multimodal Argument Mining Toolkit (2024, TNone)
