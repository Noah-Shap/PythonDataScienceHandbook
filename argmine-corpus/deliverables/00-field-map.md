...
Generated: 2026-09-16T02:06:29+00:00 | criteria_version: 1
...
|---|------|-------|-----------|
| 6.1 | Formal foundations (`formal`) | 30 | 51 |
...
| 6.5 | LLM era, 2023-2026 (`llm`) | 40 | 56 |
| 6.6 | Datasets, tools, annotation guidelines (`resources`) | 30 | 70 |

### 6.1 Formal foundations  `formal`  (quota >= 30, currently 51)
...
### 6.5 LLM era, 2023-2026  `llm`  (quota >= 40, currently 56)
...
- **T1** - Foundational / survey. Read in full: theory anchors, major surveys, canonical papers. (15 in corpus)
- **T2** - Core method. Defines a task formulation, model, or evaluation still in use. (71 in corpus)
- **T3** - Dataset / tool / annotation guideline, including the guideline documents themselves. (39 in corpus)
