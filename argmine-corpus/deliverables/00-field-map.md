...
Generated: 2026-09-16T03:20:09+00:00 | criteria_version: 1
...
| 6.2 | Argument mining (NLP) (`mining`) | 60 | 127 |
| 6.3 | Argument quality and evaluation (`quality`) | 40 | 56 |
| 6.4 | Dialogue and debate (`dialogue`) | 40 | 40 |
| 6.5 | LLM era, 2023-2026 (`llm`) | 40 | 55 |
| 6.6 | Datasets, tools, annotation guidelines (`resources`) | 30 | 70 |
...
### 6.2 Argument mining (NLP)  `mining`  (quota >= 60, currently 127)
...
### 6.3 Argument quality and evaluation  `quality`  (quota >= 40, currently 56)
...
### 6.6 Datasets, tools, annotation guidelines  `resources`  (quota >= 30, currently 70)
...
- **T2** - Core method. Defines a task formulation, model, or evaluation still in use. (74 in corpus)
- **T3** - Dataset / tool / annotation guideline, including the guideline documents themselves. (40 in corpus)
