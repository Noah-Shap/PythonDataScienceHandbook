...
Generated: 2026-09-16T03:25:39+00:00 | criteria_version: 1
...
|---|------|-------|-----------|
| 6.1 | Formal foundations (`formal`) | 30 | 54 |
| 6.2 | Argument mining (NLP) (`mining`) | 60 | 125 |
| 6.3 | Argument quality and evaluation (`quality`) | 40 | 57 |
| 6.4 | Dialogue and debate (`dialogue`) | 40 | 40 |
| 6.5 | LLM era, 2023-2026 (`llm`) | 40 | 53 |
| 6.6 | Datasets, tools, annotation guidelines (`resources`) | 30 | 71 |

### 6.1 Formal foundations  `formal`  (quota >= 30, currently 54)
...
### 6.3 Argument quality and evaluation  `quality`  (quota >= 40, currently 57)
...
### 6.5 LLM era, 2023-2026  `llm`  (quota >= 40, currently 53)
...
### 6.6 Datasets, tools, annotation guidelines  `resources`  (quota >= 30, currently 71)
...
- **T2** - Core method. Defines a task formulation, model, or evaluation still in use. (72 in corpus)
- **T3** - Dataset / tool / annotation guideline, including the guideline documents themselves. (41 in corpus)
- **T4** - Recent (2023-2026). LLM-era work; lower durability confidence, high build relevance. (14 in corpus)
