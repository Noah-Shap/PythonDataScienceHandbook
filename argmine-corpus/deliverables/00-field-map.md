...
Generated: 2026-09-16T01:59:00+00:00 | criteria_version: 1
...
### 6.2 Argument mining (NLP)  `mining`  (quota >= 60, currently 123)
...
### 6.6 Datasets, tools, annotation guidelines  `resources`  (quota >= 30, currently 68)
...
- **T1** - Foundational / survey. Read in full: theory anchors, major surveys, canonical papers. (16 in corpus)
- **T2** - Core method. Defines a task formulation, model, or evaluation still in use. (73 in corpus)
- **T3** - Dataset / tool / annotation guideline, including the guideline documents themselves. (34 in corpus)
