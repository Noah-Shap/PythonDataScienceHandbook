...
Generated: 2026-09-16T01:41:16+00:00 | criteria_version: 1
...
|---|------|-------|-----------|
| 6.1 | Formal foundations (`formal`) | 30 | 36 |
| 6.2 | Argument mining (NLP) (`mining`) | 60 | 97 |
| 6.3 | Argument quality and evaluation (`quality`) | 40 | 62 |
| 6.4 | Dialogue and debate (`dialogue`) | 40 | 52 |
| 6.5 | LLM era, 2023-2026 (`llm`) | 40 | 52 |
| 6.6 | Datasets, tools, annotation guidelines (`resources`) | 30 | 85 |

### 6.1 Formal foundations  `formal`  (quota >= 30, currently 36)
...
### 6.2 Argument mining (NLP)  `mining`  (quota >= 60, currently 97)
...
### 6.3 Argument quality and evaluation  `quality`  (quota >= 40, currently 62)
...
### 6.4 Dialogue and debate  `dialogue`  (quota >= 40, currently 52)
...
### 6.5 LLM era, 2023-2026  `llm`  (quota >= 40, currently 52)
...
### 6.6 Datasets, tools, annotation guidelines  `resources`  (quota >= 30, currently 85)
...
- **T1** - Foundational / survey. Read in full: theory anchors, major surveys, canonical papers. (17 in corpus)
- **T2** - Core method. Defines a task formulation, model, or evaluation still in use. (72 in corpus)
- **T3** - Dataset / tool / annotation guideline, including the guideline documents themselves. (49 in corpus)
- **T4** - Recent (2023-2026). LLM-era work; lower durability confidence, high build relevance. (16 in corpus)
