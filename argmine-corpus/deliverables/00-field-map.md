...
Generated: 2026-09-16T01:52:13+00:00 | criteria_version: 1
...
|---|------|-------|-----------|
| 6.1 | Formal foundations (`formal`) | 30 | 49 |
| 6.2 | Argument mining (NLP) (`mining`) | 60 | 130 |
...
### 6.1 Formal foundations  `formal`  (quota >= 30, currently 49)
...
### 6.2 Argument mining (NLP)  `mining`  (quota >= 60, currently 130)
...
- **T2** - Core method. Defines a task formulation, model, or evaluation still in use. (71 in corpus)
- **T3** - Dataset / tool / annotation guideline, including the guideline documents themselves. (30 in corpus)
- **T4** - Recent (2023-2026). LLM-era work; lower durability confidence, high build relevance. (11 in corpus)
